...
HD_PWD='E:/Projects-/VivadoProjs/CNN_2/CNN_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Maxpool.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Maxpool.tcl
