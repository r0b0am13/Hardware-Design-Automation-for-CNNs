...
#
# Generated by export_simulation on Tue Oct 28 12:15:56 +0530 2025
#
################################################################################
...
'-reset_run' switch to the './Full_CNN.sh' script.

./Full_CNN.sh -reset_run
...
./Full_CNN.sh -noclean_files

For more information on the script, please type './Full_CNN.sh -help'.
