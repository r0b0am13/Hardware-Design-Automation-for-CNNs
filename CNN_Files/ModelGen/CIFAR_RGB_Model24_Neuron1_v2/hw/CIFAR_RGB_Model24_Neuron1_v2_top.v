// =============================================================
// Auto-generated CIFAR_RGB_Model24_Neuron1_v2_top (readable, JSON-driven)
// =============================================================
module CIFAR_RGB_Model24_Neuron1_v2_top #(
    parameter DATA_WIDTH = 24,
    parameter FRACTION_SIZE = 16,
    parameter SIGNED = 1,
    ...
    // Conv1: Conv2D
    // ------------------------------------------------------------
    wire [16*DATA_WIDTH-1:0] Conv1_out;
    wire Conv1_valid;
    Conv2D #(
        .KERNEL_SIZE(3),
        .COLUMN_NUM(32),
    ...
    // Conv2: Conv2D
    // ------------------------------------------------------------
    wire [16*DATA_WIDTH-1:0] Conv2_out;
    wire Conv2_valid;
    Conv2D #(
        .KERNEL_SIZE(3),
        .COLUMN_NUM(30),
    ...
    // Maxpool1: Max2D
    // ------------------------------------------------------------
    wire [16*DATA_WIDTH-1:0] Maxpool1_out;
    wire Maxpool1_valid;
    Max2D #(
        .KERNEL_SIZE(2),
        .DATA_WIDTH(DATA_WIDTH),
    ...
    // Conv3: Conv2D
    // ------------------------------------------------------------
    wire [32*DATA_WIDTH-1:0] Conv3_out;
    wire Conv3_valid;
    Conv2D #(
        .KERNEL_SIZE(3),
        .COLUMN_NUM(14),
        ...
        .ACTIVATION(1),
        .GUARD_TYPE(GUARD_TYPE),
        .WEIGHT_FILE("c_3_w.mif"),
        .BIAS_FILE("c_3_b.mif")
    ) Conv3 (
        .clock(clock),
        .sreset_n(sreset_n),
        .data_valid(Maxpool1_valid),
        .data_in(Maxpool1_out),
        .conv_out(Conv3_out),
        .conv_valid(Conv3_valid)
    );

    // ------------------------------------------------------------
    // Conv4: Conv2D
    // ------------------------------------------------------------
    wire [1*DATA_WIDTH-1:0] Conv4_out;
    wire Conv4_valid;
    Conv2D #(
        .KERNEL_SIZE(3),
        .COLUMN_NUM(12),
        ...
        .ACTIVATION(1),
        .GUARD_TYPE(GUARD_TYPE),
        .WEIGHT_FILE("c_4_w.mif"),
        .BIAS_FILE("c_4_b.mif")
    ) Conv4 (
        .clock(clock),
        .sreset_n(sreset_n),
        .data_valid(Conv3_valid),
        .data_in(Conv3_out),
        .conv_out(Conv4_out),
        .conv_valid(Conv4_valid)
    );

    // ------------------------------------------------------------
    // Maxpool2: Max2D
    // ------------------------------------------------------------
    wire [1*DATA_WIDTH-1:0] Maxpool2_out;
    wire Maxpool2_valid;
    Max2D #(
        .KERNEL_SIZE(2),
        .DATA_WIDTH(DATA_WIDTH),
        ...
        .clock(clock),
        .sreset_n(sreset_n),
        .data_valid(Conv4_valid),
        .data_in(Conv4_out),
        .maxp_out(Maxpool2_out),
        .maxp_valid(Maxpool2_valid)
    );
    ...
    // ------------------------------------------------------------
    // Layer 1 — dense_L1 (RELU, 128 neurons)
    // ------------------------------------------------------------
    wire [127:0] o1_valid;
    wire [128*DATA_WIDTH-1:0] x1_out;
    reg  [128*DATA_WIDTH-1:0] holdData_1;
    ...
    // ------------------------------------------------------------
    // Layer 2 — dense_L2 (RELU, 64 neurons)
    // ------------------------------------------------------------
    wire [63:0] o2_valid;
    wire [64*DATA_WIDTH-1:0] x2_out;
    reg  [64*DATA_WIDTH-1:0] holdData_2;
